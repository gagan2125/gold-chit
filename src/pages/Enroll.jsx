            ...
            <div className="mt-6 mb-8">
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <button
                  ...
                  className="ml-4 bg-blue-800 text-white px-4 py-2 rounded shadow-md hover:bg-yellow-500
              ...
              <button
                ...
                className={`w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center ${
                  loading
                    ...
                    : "bg-blue-700 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300"
                }`}
              >
                {loading ? (
                  <>
